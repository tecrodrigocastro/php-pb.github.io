...
<section id="eventos" class="py-20 lg:py-32 bg-slate-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @else
            <p class="text-center text-slate-400">Nenhum evento agendado no momento. Volte em breve!</p>
        @endif

        <!-- View all CTA -->
        <div class="text-center mt-12">
            <a href="{{ route('events.index') }}" class="inline-flex items-center px-6 py-3 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-lg transition-all">
